...
const TodoItem = (props) => {
  ...
  return (
    <View style={styles.itemContainer}>
      <Pressable hitSlop={10} style={styles.itemCheckbox} onPress={() => dispatch(updateTodo(props.id))}>
        {props.state === "todo" ? <CheckboxUnchecked /> : <CheckboxChecked style={styles.itemCheckboxCheckedIcon} />}
      </Pressable>
